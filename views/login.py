...
from models import db, f_bcrypt
...
def register():
    ...
    if form.validate_on_submit():
        hashed_password = f_bcrypt.generate_password_hash(form.password.data).decode('utf-8')
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and f_bcrypt.check_password_hash(user.password, form.password.data):
